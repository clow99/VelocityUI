...
const managers = [
  { label: 'npm', command: 'npm install @velocityuikit/velocityui' },
  { label: 'pnpm', command: 'pnpm add @velocityuikit/velocityui' },
  { label: 'yarn', command: 'yarn add @velocityuikit/velocityui' },
]
